...
import com.matsaf123.newsapiapp.util.Constants.Companion.QUERY_PAGE_SIZE
            ...
            when(response) {
                is Resource.Success -> {
                    ...
                    response.data?.let {newsResponse ->
                        ...
                        val totalPages = newsResponse.totalResults/ QUERY_PAGE_SIZE+2   // +2 -> +1 because of rounding INTEGER and also +1 because the last page of response will be empty
